...
public class dormitori extends zona{
	...
	private int est;
	private	 int oest;
	utils clau = new utils("clau",false,1, false);
	 
	public dormitori(String nom, int num, int nord, int sud, int est, int oest) {
