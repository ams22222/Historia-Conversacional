...
public class cuina extends zona{
	...
	private int est;
	private	 int oest;
	utils donuts = new utils("donuts",false,7,false); 

	public cuina(String nom, int num, int nord, int sud, int est, int oest) {
