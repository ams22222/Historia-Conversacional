...
public class vestuari extends zona{
	...
	private int est;
	private	 int oest;
	utils vestimenta = new utils("vestimenta",false,6, false);  

	public vestuari(String nom, int num, int nord, int sud, int est, int oest) {
