...
public class taller extends zona{
	...
	private int est;
	private	 int oest;
	utils eina = new utils("eina",false,4,false); 

	public taller(String nom, int num, int nord, int sud, int est, int oest) {
