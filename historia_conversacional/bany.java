...
public class bany extends zona {
	...
	private int est;
	private	 int oest;
	utils contrasenya = new utils("paper",false,2,false);
 

	public bany(String nom, int num, int nord, int sud, int est, int oest) {
